...
function viz2D3D_line_deformed(fem,opts,dispType) 
...
fprintf(['Max Displacement is %3.', num2str(rd) ,'f mm \n'],maxDisp);
fprintf(['Min Displacement is %3.', num2str(rd) ,'f mm \n'],minDisp);
...
switch dispType
    ...
    case 'U1'
        title('Displacement U1');
    case 'U2'
        title('Displacement U2');
    case 'U3'
        title('Displacement U3');
end
